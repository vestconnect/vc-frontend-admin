				...
				loading
					...
					!contents.length
						...
						<ContainerLoading>
							...
							<span style={{ marginBottom: 0 }}>O conteúdo não tem fotos cadastradas</span>
						</ContainerLoading>
						:
						<Table>
							<thead>
								...
								{contents.map(content => {
									return (
										<tr key={content.id}>
											...
											<ActionColumnTd>
												<div>
													<TableButton href={content.file_url} target="_blank" rel="noopener noreferrer"><div><FiCamera size={20} /> Visualizar foto</div></TableButton>
												</div>
											</ActionColumnTd>
										</tr>
									)
